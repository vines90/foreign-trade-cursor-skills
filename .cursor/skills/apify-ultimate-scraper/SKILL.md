...
```bash
node --env-file=.env .cursor/skills/apify-ultimate-scraper/reference/scripts/search_actors.js --query "SEARCH_KEYWORDS"
```
...
```bash
node --env-file=.env .cursor/skills/apify-ultimate-scraper/reference/scripts/fetch_actor_details.js --actor "ACTOR_ID"
```
